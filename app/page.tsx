...
const services = [
  ...
  },
  {
    ...
    caption: "AWS, Azure, and Google Cloud delivery with automation-first tooling.",
  },
  {
  ...
  },
  {
    ...
    caption: "24/7 monitoring, rapid issue resolution, and ITIL-aligned processes.",
  },
  {
    title: "System Integration & QA",
    caption: "Connect disparate platforms with secure workflows and QA disciplines.",
  },
  {
...
const stats = [
  ...
  { label: "Years in IT Services", value: "2+" },
  { label: "Uptime Guarantee", value: "99%" },
  { label: "Projects & Services", value: "30+" },
];

const contact = {
  address:
    "2nd Floor, SCR Towers, 202, above Rajesh Motors, Siddhi Vinayak Nagar, Madhapur, Khanammet, Hyderabad, Telangana 500081",
  email: "info@technocommunicationsglobal.com",
  phone: "+918019507755",
};

const remoteImages = {
  hero: "https://images.unsplash.com/photo-1529333166437-7750a6dd5a70?auto=format&fit=crop&w=900&q=80",
  services: "https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7?auto=format&fit=crop&w=900&q=80",
  approach: "https://images.unsplash.com/photo-1474631245212-32dc3c8310c6?auto=format&fit=crop&w=900&q=80",
};
        ...
        <section className="rounded-[32px] ">
          <div className="space-y-5 text-center">
            <h2 className="text-5xl font-bold tracking-tight text-slate-900">
              Welcome to <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#e10174] to-[#a504ff]">Techno Communications Global</span>
            </h2>
           <p className="text-lg text-slate-600 mx-auto max-w-3xl">
  We blend modern IT, BPO, and HR services with a human-first delivery model.  
  Explore our vision, services, and leadership to find the right partnership path.
</p>  <p className="text-lg text-slate-600 mx-auto max-w-3xl">Build career with us</p>
          </div>
          <div className="mt-8 flex flex-col gap-4 text-md font-semibold uppercase tracking-[0.4em] md:flex-row md:justify-center">
            <a
              href="/careers"
        ...
        <HeroSection heroHighlights={heroHighlights} imageUrl={remoteImages.hero} contactEmail={contact.email} />
        ...
        <section className="space-y-6 rounded-[32px]  bg-white p-10">
          <div>
            ...
            <h2 className="text-3xl font-semibold text-slate-900 space-y-8 text-center">A technology partner that listens, designs, and delivers.</h2>
          </div>
          <div className="grid gap-6 md:grid-cols-2">
            <article className="rounded-3xl border border-slate-200 bg-slate-50 p-6">
              ...
              <p className="mt-3 text-md text-slate-600">
                Empower businesses with exceptional IT solutions so leaders stay focused on their core competencies. We deliver scalable, reliable services that keep your people and infrastructure humming.
              </p>
            ...
            <article className="rounded-3xl  bg-slate-50 p-6">
              ...
              <p className="mt-3 text-md text-slate-600">
                To become the most trusted technology partner for businesses across India and beyond—driving seamless digital transformation with expert guidance, innovative solutions, and unwavering support.
              </p>
        ...
        <ServicesSection services={services} stats={stats} imageUrl={remoteImages.services} />

        <ApproachSection steps={processSteps} imageUrl={remoteImages.approach} />
          ...
          <div className="grid gap-10 lg:grid-cols-[1fr_0.85fr] lg:items-center">
            ...
            <div>
              ...
              <p className="mt-4 text-md text-slate-600">
                Arun Potharaju shares how transparency, human-first delivery, and a relentless focus on innovation keep
                TCGL moving ahead. Explore the full CEO message to understand what inspires every engagement.
              </p>
              <div className="mt-6 flex flex-wrap gap-4">
                <a
                  href="/ceo-message"
                  className="rounded-full bg-slate-900 px-6 py-3 text-[10px] font-semibold uppercase tracking-[0.4em] text-white transition hover:bg-slate-700"
                >
                  Read the CEO message
                </a>
                <a
                  href="/careers"
                  className="rounded-full border border-slate-900 px-6 py-3 text-[10px] font-semibold uppercase tracking-[0.4em] text-slate-900 transition hover:border-emerald-500"
                >
                  Explore careers
                </a>
              </div>
